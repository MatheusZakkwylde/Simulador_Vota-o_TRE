...
public class Login extends javax.swing.JFrame {
    ...
    private void entrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_entrarActionPerformed
        ...
        if (Dao.secaoExiste(secao.getText()) != null) {
            Dao.SetSecaoTerminal(secao.getText());
            JanelaTerminal terminal = new JanelaTerminal();
            terminal.setVisible(true);
            this.dispose();
        } else {
            JOptionPane.showMessageDialog(null, "Seção não cadastrada", "Seção", JOptionPane.INFORMATION_MESSAGE, null);
        }
