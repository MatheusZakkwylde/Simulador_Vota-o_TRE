...
public class JanelaGovernador extends javax.swing.JFrame {

    public JanelaGovernador() {
        initComponents();
        setSize(700, 400);
        cargo.setText("Governador(a):");
    ...
    private void initComponents() {
        ...
        foto.setBounds(240, 100, 100, 100);
        ...
        num5.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        num5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        num5.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)));
        getContentPane().add(num5);
        num5.setBounds(180, 100, 40, 40);
        ...
        num2.setBounds(60, 100, 40, 40);

        num3.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        num3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        num3.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)));
        getContentPane().add(num3);
        num3.setBounds(100, 100, 40, 40);

        num4.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        num4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        num4.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)));
        getContentPane().add(num4);
        num4.setBounds(140, 100, 40, 40);

        numerop.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)));
        getContentPane().add(numerop);
        numerop.setBounds(10, 30, 340, 260);
    ...
    private void btnUmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUmActionPerformed
        ...
        //se for igual a 05 ele mostra os dados do candidato. mas tem que ser embaixo 
        //porque o código roda de cima para baixo
        if (passa == 5) {
            candidato();
        }
    ...
    private void btnConfirmaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnConfirmaMousePressed
        //mesma coisa que acontece na de prefeito. Muda apenas que aqui neste caso é para governador
        if (condicao == false) {
            Dao.setarVotoGovernador("21110");
            play("fim");
            JOptionPane.showMessageDialog(null, "Voto Finalizado com sucesso!");
            Dao.travaUrna();
    ...
    private void candidato() {
        Candidato candidato = Dao.candidatoGonvernador(num1.getText() + num2.getText() + num3.getText() + num4.getText() + num5.getText());
        if (candidato != null) {
