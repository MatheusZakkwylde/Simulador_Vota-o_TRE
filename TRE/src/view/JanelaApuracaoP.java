...
import controller.GraficoApuracaoP;
import java.awt.BorderLayout;

public class JanelaApuracaoP extends javax.swing.JFrame {

    public JanelaApuracaoP() {
        initComponents();
        setSize(1224, 700);
         GraficoApuracaoP grafico = new GraficoApuracaoP();
        this.painelGraficoP.setLayout(new BorderLayout());
        this.painelGraficoP.add(grafico.jfreechar());
    }
    ...
    private void initComponents() {
        ...
        painelGraficoP = new javax.swing.JPanel();
        ...
        getContentPane().add(painelGraficoP);
        painelGraficoP.setBounds(0, 0, 1270, 640);
    ...
    private javax.swing.JPanel painelGraficoP;
