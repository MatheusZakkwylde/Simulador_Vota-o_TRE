...
import controller.GraficoApuracaoG;
import java.awt.BorderLayout;

public class JanelaApuracaoG extends javax.swing.JFrame {

    public JanelaApuracaoG() {
        initComponents();
        setSize(1224, 700);
         GraficoApuracaoG grafico = new GraficoApuracaoG();
    ...
    private void initComponents() {
        ...
        painelGraficoG.setBounds(0, 0, 1270, 650);
